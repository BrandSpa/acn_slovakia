  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <span style={this.state.showMemberExists ? {float: 'left', width: '100%', padding: '10px', marginTop: '10px', background: '#f4334a', color: '#fff'} :{display: 'none'}}>{'you are already praying'}</span>
      </form>
    );
  }
});
