...
<div class="flexslider">
  <ul class="slides">
		<?php foreach(explode(',', $at['images']) as $image):?>
		 <li>
     	 <img src="<?php echo wp_get_attachment_url($image)  ?>" rel="prueba" alt="<?php echo get_post_meta($image, '_wp_attachment_image_alt', true);;  ?>" data-title="<?php echo wp_get_attachment( $image );  ?>" />
    </li>
		<?php
		endforeach;
		?>
