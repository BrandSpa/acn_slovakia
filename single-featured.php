...
<div class="bs-post__header--image" style="background-image: url(<?php echo get_the_post_thumbnail_url($post->ID, 'full') ?>)">
    <div class="bs-feat__img__textbox" style="background:black;">
        ...
        <span class="featured__metadata" style="font-size: 15px; color: #e1e1e1; line-height:1.53; text-align:left;">
				<?php foreach(get_the_category($post->ID) as $ind => $category): ?>
					<span style="font-weight:600; font-size:18px; color:#eaeaea line-height:1.28;">
        ...
        <div class="breadcrumbs" style=" color: #e1e1e1; text-align:left; " typeof="BreadcrumbList" vocab="https://schema.org/">
